...
class NavigationIconView {
  ...
  constructor({ icon, activeIcon, title, color, vsync } : { icon?: any; activeIcon?: any; title?: any; color?: any; vsync?: any; } = {}) {
    this._icon = icon;
    this._title = title;
    this._color = color;
    ...
    this._animation = this.controller.drive(
      new CurveTween({
  ...
  transition(type, context) {
    ...
    if (type == BottomNavigationBarType.shifting) {
      ...
      iconColor = themeData.primaryColorBrightness == Brightness.light ? themeData.primaryColor : themeData.accentColor;
...
class JSBottomNavigationDemoState extends MXJSWidgetState {
  ...
  private _type: BottomNavigationBarType;
