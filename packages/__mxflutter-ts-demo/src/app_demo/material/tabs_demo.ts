...
class _CardData {
  ...
  public imageAssetPackage: any;
  constructor({ title, imageAsset, imageAssetPackage }) {
    (this.title = title), (this.imageAsset = imageAsset), (this.imageAssetPackage = imageAssetPackage);
  }
}
