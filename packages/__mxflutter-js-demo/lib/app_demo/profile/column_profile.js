...
import { Scaffold, Colors, AppBar, FlatButton, Card, } from '@mxflutter/mxflutter-widgets/material';
import { Container, Text, Icon, IconData, Row, Padding, Expanded, Column, ClipRRect, AspectRatio, SingleChildScrollView, } from '@mxflutter/mxflutter-widgets/widgets';
import { Color, TextStyle, Duration, FontWeight, } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
import { EdgeInsets, BoxFit, BorderSide, BoxDecoration, Alignment, BorderRadius, BorderDirectional, } from '@mxflutter/mxflutter-widgets/painting';
import { CrossAxisAlignment, } from '@mxflutter/mxflutter-widgets/rendering';
import { CachedNetworkImage } from '@mxflutter/mxflutter-cached-network-image';
//
...
class PerformanceProfilingWidgetState extends MXJSWidgetState {
    ...
    build(context) {
        ...
        return new Card({
            ...
            margin: EdgeInsets.fromLTRB(8.0, 8.0, 10.0, 0.0)
        });
    }
    // onBuildEnd(args) {
...
class ColumnProfileDemo1 extends MXJSStatefulWidget {
    constructor() {
        super('ListViewDemo');
        this.enableProfile = true;
    }
    createState() {
        return new ColumnProfileDemo1State(this);
    }
}
class ColumnProfileDemo1State extends MXJSWidgetState {
    constructor(widget) {
        super();
        this.newsArray = [];
        this.buildCount = 0;
