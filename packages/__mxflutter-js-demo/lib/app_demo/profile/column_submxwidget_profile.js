...
import { Scaffold, Colors, AppBar, FlatButton, } from '@mxflutter/mxflutter-widgets/material';
import { Container, Text, Icon, IconData, Row, Expanded, Column, ClipRRect, AspectRatio, SingleChildScrollView, } from '@mxflutter/mxflutter-widgets/widgets';
import { TextStyle, Duration, FontWeight, } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
...
let g_newsOrder = 0;
//
class ColumnProfileDemo2 extends MXJSStatefulWidget {
    constructor() {
        super('ListViewDemo');
    }
    createState() {
        return new ColumnProfileDemo2State(this);
    }
}
class ColumnProfileDemo2State extends MXJSWidgetState {
    constructor() {
        super();
        this.newsArray = [];
        this.buildCount = 1;
