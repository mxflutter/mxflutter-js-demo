...
import { Scaffold, Colors, Theme, ThemeData, SliverAppBar, IconButton, PopupMenuButton, PopupMenuItem, FlexibleSpaceBar, Container, Text, Icon, IconData, Row, Padding, Image, CustomScrollView, SliverChildListDelegate, Expanded, Column, MergeSemantics, SizedBox, Stack, AnnotatedRegion, DecoratedBox, SliverList, DefaultTextStyle, SafeArea, Color, Brightness, EdgeInsets, BoxFit, BorderSide, BoxDecoration, Border, LinearGradient, Alignment, StackFit, CrossAxisAlignment, MainAxisAlignment, } from '@mxflutter/mxflutter-widgets/material';
// import {
//     Container,
//     Text,
//     Icon,
...
import { SystemUiOverlayStyle } from '@mxflutter/mxflutter-widgets/services';
                ...
                delegate: new SliverChildListDelegate([
                    new AnnotatedRegion({
                        ...
                        child: new ContactCategory({
                            icon: new IconData(0xe0b0, {
                                fontFamily: 'MaterialIcons'
                            }),
                            children: [
                                new ContactItem({
                                    icon: new IconData(0xe0c9, {
                                        fontFamily: 'MaterialIcons'
                                    }),
                    ...
                    new ContactCategory({
                        icon: new IconData(0xe0d0, {
                            fontFamily: 'MaterialIcons'
                        }),
                        children: [
                            new ContactItem({
                                icon: new IconData(0xe0be, {
                                    fontFamily: 'MaterialIcons'
                                }),
                    ...
                    new ContactCategory({
                        icon: new IconData(0xe0c8, {
                            fontFamily: 'MaterialIcons'
                        }),
                        children: [
                            new ContactItem({
                                icon: new IconData(0xe55b, {
                                    fontFamily: 'MaterialIcons'
                                }),
                                tooltip: 'Open map',
                                onPressed: function () {
