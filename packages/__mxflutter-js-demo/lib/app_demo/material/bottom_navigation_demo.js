...
import { Scaffold, Colors, AppBar, Theme, BottomNavigationBar, BottomNavigationBarType, } from '@mxflutter/mxflutter-widgets/material';
import { Container, Text, Icon, IconData, Center, Stack, BottomNavigationBarItem, Semantics, FadeTransition, SlideTransition, IconTheme, IconThemeData, } from '@mxflutter/mxflutter-widgets/widgets';
import { Duration, Brightness, Offset } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
import { EdgeInsets, BoxDecoration, Border, } from '@mxflutter/mxflutter-widgets/painting';
import { Tween, AnimationController, CurveTween, Interval, Curves } from '@mxflutter/mxflutter-widgets/animation';
...
class JSBottomNavigationDemoState extends MXJSWidgetState {
    ...
    build(context) {
        this._navigationViews = [
            new NavigationIconView({
                icon: new Icon(new IconData(0xe190, {
            ...
            new NavigationIconView({
                activeIcon: new Icon(new IconData(0xe2bd, {
                    fontFamily: 'MaterialIcons'
                })),
                icon: new Icon(new IconData(0xe2c2, {
                    fontFamily: 'MaterialIcons'
                })),
                title: 'Cloud',
                color: Colors.teal
            ...
            new NavigationIconView({
                activeIcon: new Icon(new IconData(0xe87d, {
                    fontFamily: 'MaterialIcons'
                })),
                icon: new Icon(new IconData(0xe87e, {
                    fontFamily: 'MaterialIcons'
                })),
                title: 'Favorites',
                color: Colors.indigo
            ...
            new NavigationIconView({
                icon: new Icon(new IconData(0xe614, {
                    fontFamily: 'MaterialIcons'
                })),
                title: 'Event',
                color: Colors.pink
