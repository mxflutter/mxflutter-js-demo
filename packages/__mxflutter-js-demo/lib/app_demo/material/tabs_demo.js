...
import { Scaffold, Theme, Card, TabBarView, CircleAvatar, DefaultTabController, } from '@mxflutter/mxflutter-widgets/material';
import { Text, Padding, Center, Image, CustomScrollView, Column, SizedBox, SafeArea, SliverPadding, SliverChildBuilderDelegate, Align, NestedScrollView, Builder, SliverFixedExtentList } from '@mxflutter/mxflutter-widgets/widgets';
import { EdgeInsets, BoxFit, Alignment, } from '@mxflutter/mxflutter-widgets/painting';
import { CrossAxisAlignment, MainAxisAlignment, } from '@mxflutter/mxflutter-widgets/rendering';
                ...
                child: new Column({
                    ...
                    children: [
                        ...
                        new SizedBox({
                            width: 144.0,
                            height: 144.0,
                            child: Image.asset(this.data.imageAsset, {
                                fit: BoxFit.contain,
                                __mx_package: this.data.imageAssetPackage
                            })
                        }),
                        new Center({
                            child: new Text(this.data.title, {
                                            ...
                                            slivers: [
                                                ...
                                                new SliverPadding({
                                                    ...
                                                    sliver: new SliverFixedExtentList({
                                                        ...
                                                        delegate: new SliverChildBuilderDelegate(function (context, index) {
