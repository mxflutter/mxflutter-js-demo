...
import { Scaffold, Colors, AppBar, FloatingActionButton, IconButton, PopupMenuButton, PopupMenuItem, FlatButton, TextField, InputDecoration, RaisedButton, DropdownButton, DropdownMenuItem, ButtonBar, TextFormField, UnderlineInputBorder, Slider, } from '@mxflutter/mxflutter-widgets/material';
import { Container, Text, ListView, Icon, IconData, Row, Expanded, Column, SizedBox, RichText, TextEditingController, } from '@mxflutter/mxflutter-widgets/widgets';
import { Color, TextStyle, FontWeight, TextDecoration, FontStyle, TextDecorationStyle, } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
import { EdgeInsets, TextSpan, } from '@mxflutter/mxflutter-widgets/painting';
import { MainAxisAlignment, MainAxisSize, TextOverflow, } from '@mxflutter/mxflutter-widgets/rendering';
import { TextInputType } from '@mxflutter/mxflutter-widgets/services';
            ...
            children: [
                new Row({
                    ...
                    children: [
                        ...
                        new IconButton({
                            icon: new Icon(new IconData(0xe815, {
                                fontFamily: 'MaterialIcons'
                            })),
                            onPressed: function () {
                ...
                children: [
                    new Row({
                        ...
                        children: [
                            new IconButton({
                                ...
                                icon: new Icon(new IconData(0xe87c, {
                                    fontFamily: 'MaterialIcons'
                                })),
                                onPressed: function () {
                    ...
                    new Row({
                        ...
                        children: [
                            new IconButton({
                                color: iconColors[this.iconColorIndex],
                                icon: new Icon(new IconData(0xe001, {
                                    fontFamily: 'MaterialIcons'
                                })),
                                onPressed: function () {
                                    this.iconColorIndex = (this.iconColorIndex + 1) % iconColors.length;
                    ...
                    new Container({
                        ...
                        child: new TextFormField({
                            decoration: new InputDecoration({
                                ...
                                filled: true,
                                icon: new Icon(new IconData(0xe0be, {
                                    fontFamily: 'MaterialIcons'
                                })),
                    ...
                    new Container({
                        ...
                        child: new TextFormField({
                            decoration: new InputDecoration({
                                border: new UnderlineInputBorder(),
                                filled: true,
                                icon: new Icon(new IconData(0xe0cd, {
                                    fontFamily: 'MaterialIcons'
                                })),
