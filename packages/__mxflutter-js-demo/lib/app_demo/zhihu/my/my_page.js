...
import { MaterialApp, Scaffold, Colors, AppBar, ListTile, MaterialPageRoute, FlatButton, CircleAvatar, } from '@mxflutter/mxflutter-widgets/material';
import { Container, Text, Icon, IconData, Row, Navigator, Expanded, Column, AspectRatio, MediaQuery, SingleChildScrollView, Align, } from '@mxflutter/mxflutter-widgets/widgets';
import { Color, TextStyle, Rect, Radius } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
import { EdgeInsets, BorderSide, BoxDecoration, Alignment, BorderRadius, BorderDirectional, DecorationImage, NetworkImage, Axis, } from '@mxflutter/mxflutter-widgets/painting';
        ...
        return new Container({
            child: new FlatButton({
                ...
                child: new Row({
                    children: [
                        new Container({
                            child: new Icon(new IconData(0xe8b6, {
                        ...
                        new Container({
                            child: new FlatButton({
                                onPressed: function () { },
                                child: new Icon(new IconData(0xe8c4, {
                                    fontFamily: 'MaterialIcons'
                                }), {
                                    color: GlobalConfig.fontColor,
                                    size: 18.0
                    ...
                    child: new Column({
                        children: [
                            new Container({
                                ...
                                child: new CircleAvatar({
                                    radius: 20.0,
                                    child: new Icon(new IconData(iconDataValue, {
                                        fontFamily: 'MaterialIcons'
                                    }), {
                                        color: Colors.white
                                    }),
            ...
            child: new Row({
                children: [
                    ...
                    new Container({
                        child: new FlatButton({
                            onPressed: function () { },
                            child: new Text(nextActionTitle, {
                                style: new TextStyle({
                                    color: Colors.blue
                                })
                            })
