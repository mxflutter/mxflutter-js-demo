...
import { Colors, MaterialPageRoute, PopupMenuButton, PopupMenuItem, FlatButton, CircleAvatar, } from '@mxflutter/mxflutter-widgets/material';
...
import { Color, TextStyle, FontWeight, Rect, Radius } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
import { EdgeInsets, BoxDecoration, Border, Alignment, BorderRadius, DecorationImage, NetworkImage, } from '@mxflutter/mxflutter-widgets/painting';
                        ...
                        new Container({
                            child: new Row({
                                children: [
                                    ...
                                    new PopupMenuButton({
                                        icon: new Icon(new IconData(0xe260, {
