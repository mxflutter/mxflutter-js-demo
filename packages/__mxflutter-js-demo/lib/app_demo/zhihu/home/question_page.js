...
import { MaterialApp, Scaffold, Colors, AppBar, MaterialPageRoute, PopupMenuButton, PopupMenuItem, FlatButton, CircleAvatar, ButtonTextTheme } from '@mxflutter/mxflutter-widgets/material';
...
import { TextAlign, TextStyle, FontWeight, } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
import { EdgeInsets, BorderSide, BoxDecoration, Alignment, BorderDirectional, NetworkImage, } from '@mxflutter/mxflutter-widgets/painting';
                ...
                body: new SingleChildScrollView({
                    child: new Column({
                        children: [
                            ...
                            new Container({
                                child: new Text("如果，仅考虑其延长强相互作用力的特性，而不考虑其直角转弯的特性，那么水滴能被制造出来吗？换句话说，强相互作用力能够以影响微观物理量的方式延长吗？", {
                                    style: new TextStyle({
                                        height: 1.4,
                                        fontSize: 16.0,
                                ...
                                child: new FlatButton({
                                    ...
                                    child: new Column({
                                        children: [
                                            ...
                                            new Container({
                                                child: new Text("第一，几年前我跟一个985211级别大学的物理类学科教授聊过这个问题。他很严肃的表示，使用强互作用力为工具在原子角度加工出这种水平的材料，对人类目前的物理...", {
                                                    style: new TextStyle({
                                                        height: 1.3,
                                                        color: GlobalConfig.fontColor
                                                    })
