...
import { Scaffold, AppBar, FloatingActionButton, SliverAppBar, IconButton, Card, Text, Icon, IconData, Row, Padding, Center, Image, CustomScrollView, Expanded, Column, AspectRatio, MediaQuery, SliverPadding, SliverGrid, SliverChildBuilderDelegate, GestureDetector, Hero, EdgeInsets, BoxFit, Tween, CrossAxisAlignment, MainAxisAlignment, SliverGridDelegateWithMaxCrossAxisExtent } from '@mxflutter/mxflutter-widgets/material';
// import {
//   Text,
//   Icon,
//   IconData,
                    ...
                    children: [
                        new Hero({
                            ...
                            child: new AspectRatio({
                                aspectRatio: 4.0 / 3.0,
                                child: Image.asset(this.recipe.imagePath, {
                            ...
                            child: new Row({
                                children: [
                                    new Padding({
                                        ...
                                        child: Image.asset(this.recipe.ingredientsImagePath, {
