...
import { Scaffold, AppBar, ListTile, } from '@mxflutter/mxflutter-widgets/material';
import { Text, ListView, Icon, IconData, } from '@mxflutter/mxflutter-widgets/widgets';
import { Color, } from '@mxflutter/mxflutter-widgets/mx-dart-sdk';
//业务代码
class JSStudiesPage extends MXJSStatelessWidget {
    constructor() {
        super("JSStudiesPage");
    }
    build(buildOwner) {
